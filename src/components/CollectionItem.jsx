  ...
  return (
    <div onClick={() => route.push({
      ...
      <div className="flex flex-col w-full justify-center text-center lg:text-start items-center lg:items-start">
        ...
        <span className="text-sm 2xl:text-md hidden lg:inline-block">{data.placeH} {locale === "fr" ? "Contributeurs" : locale === "es" ? "Contribuidores" : locale === "pt" ? "Contribuidores" : locale === "de" ? "Mitwirkende" : "Contributors"}</span>
